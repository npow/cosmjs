...
export interface QueryNFTsOfClassRequest {
  classId: string;
  owner: string;
...
export interface QueryNFTsOfClassResponse {
  nfts: NFT[];
...
const baseQueryNFTsOfClassRequest: object = { classId: "", owner: "" };

export const QueryNFTsOfClassRequest = {
  encode(message: QueryNFTsOfClassRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.classId !== "") {
      writer.uint32(10).string(message.classId);
    }
    if (message.owner !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryNFTsOfClassRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryNFTsOfClassRequest } as QueryNFTsOfClassRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryNFTsOfClassRequest {
    const message = { ...baseQueryNFTsOfClassRequest } as QueryNFTsOfClassRequest;
    if (object.classId !== undefined && object.classId !== null) {
      message.classId = String(object.classId);
    } else {
  ...
  toJSON(message: QueryNFTsOfClassRequest): unknown {
    const obj: any = {};
    message.classId !== undefined && (obj.classId = message.classId);
    message.owner !== undefined && (obj.owner = message.owner);
    message.pagination !== undefined &&
  ...
  fromPartial(object: DeepPartial<QueryNFTsOfClassRequest>): QueryNFTsOfClassRequest {
    const message = { ...baseQueryNFTsOfClassRequest } as QueryNFTsOfClassRequest;
    if (object.classId !== undefined && object.classId !== null) {
      message.classId = object.classId;
    } else {
...
const baseQueryNFTsOfClassResponse: object = {};

export const QueryNFTsOfClassResponse = {
  encode(message: QueryNFTsOfClassResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryNFTsOfClassResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryNFTsOfClassResponse } as QueryNFTsOfClassResponse;
    message.nfts = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): QueryNFTsOfClassResponse {
    const message = { ...baseQueryNFTsOfClassResponse } as QueryNFTsOfClassResponse;
    message.nfts = [];
  ...
  toJSON(message: QueryNFTsOfClassResponse): unknown {
    const obj: any = {};
    if (message.nfts) {
  ...
  fromPartial(object: DeepPartial<QueryNFTsOfClassResponse>): QueryNFTsOfClassResponse {
    const message = { ...baseQueryNFTsOfClassResponse } as QueryNFTsOfClassResponse;
    message.nfts = [];
    if (object.nfts !== undefined && object.nfts !== null) {
      for (const e of object.nfts) {
...
export interface Query {
  ...
  NFTsOfClass(request: QueryNFTsOfClassRequest): Promise<QueryNFTsOfClassResponse>;
...
export class QueryClientImpl implements Query {
  ...
  NFTsOfClass(request: QueryNFTsOfClassRequest): Promise<QueryNFTsOfClassResponse> {
    const data = QueryNFTsOfClassRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.nft.v1beta1.Query", "NFTsOfClass", data);
    return promise.then((data) => QueryNFTsOfClassResponse.decode(new _m0.Reader(data)));
  }
