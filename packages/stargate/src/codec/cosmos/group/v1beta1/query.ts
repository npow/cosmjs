...
import { GroupInfo, GroupPolicyInfo, Proposal, Vote, GroupMember } from "../../../cosmos/group/v1beta1/types";
...
export class QueryClientImpl implements Query {
  ...
  GroupInfo(request: QueryGroupInfoRequest): Promise<QueryGroupInfoResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupInfo", data);
  ...
  GroupPolicyInfo(request: QueryGroupPolicyInfoRequest): Promise<QueryGroupPolicyInfoResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupPolicyInfo", data);
  ...
  GroupMembers(request: QueryGroupMembersRequest): Promise<QueryGroupMembersResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupMembers", data);
  ...
  GroupsByAdmin(request: QueryGroupsByAdminRequest): Promise<QueryGroupsByAdminResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupsByAdmin", data);
  ...
  GroupPoliciesByGroup(
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupPoliciesByGroup", data);
  ...
  GroupPoliciesByAdmin(
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupPoliciesByAdmin", data);
    return promise.then((data) => QueryGroupPoliciesByAdminResponse.decode(new _m0.Reader(data)));
  }

  Proposal(request: QueryProposalRequest): Promise<QueryProposalResponse> {
    const data = QueryProposalRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "Proposal", data);
  ...
  ProposalsByGroupPolicy(
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "ProposalsByGroupPolicy", data);
  ...
  VoteByProposalVoter(request: QueryVoteByProposalVoterRequest): Promise<QueryVoteByProposalVoterResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "VoteByProposalVoter", data);
  ...
  VotesByProposal(request: QueryVotesByProposalRequest): Promise<QueryVotesByProposalResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "VotesByProposal", data);
  ...
  VotesByVoter(request: QueryVotesByVoterRequest): Promise<QueryVotesByVoterResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "VotesByVoter", data);
  ...
  GroupsByMember(request: QueryGroupsByMemberRequest): Promise<QueryGroupsByMemberResponse> {
    ...
    const promise = this.rpc.request("cosmos.group.v1beta1.Query", "GroupsByMember", data);
