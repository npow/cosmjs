...
export const ThresholdDecisionPolicy = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ThresholdDecisionPolicy {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseThresholdDecisionPolicy } as ThresholdDecisionPolicy;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
const baseGroupInfo: object = { groupId: Long.UZERO, admin: "", version: Long.UZERO, totalWeight: "" };
...
const baseGroupPolicyInfo: object = { address: "", groupId: Long.UZERO, admin: "", version: Long.UZERO };
...
export const Proposal = {
  ...
  fromJSON(object: any): Proposal {
    ...
    if (object.groupPolicyVersion !== undefined && object.groupPolicyVersion !== null) {
      message.groupPolicyVersion = Long.fromString(object.groupPolicyVersion);
    } else {
    ...
    if (object.executorResult !== undefined && object.executorResult !== null) {
      message.executorResult = proposal_ExecutorResultFromJSON(object.executorResult);
    } else {
  ...
  fromPartial(object: DeepPartial<Proposal>): Proposal {
    ...
    if (object.groupPolicyVersion !== undefined && object.groupPolicyVersion !== null) {
      message.groupPolicyVersion = object.groupPolicyVersion as Long;
    } else {
      message.groupPolicyVersion = Long.UZERO;
    }
    if (object.status !== undefined && object.status !== null) {
...
const baseTally: object = { yesCount: "", noCount: "", abstainCount: "", vetoCount: "" };
