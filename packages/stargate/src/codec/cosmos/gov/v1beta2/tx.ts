...
export class MsgClientImpl implements Msg {
  ...
  SubmitProposal(request: MsgSubmitProposal): Promise<MsgSubmitProposalResponse> {
    ...
    const promise = this.rpc.request("cosmos.gov.v1beta2.Msg", "SubmitProposal", data);
  ...
  ExecLegacyContent(request: MsgExecLegacyContent): Promise<MsgExecLegacyContentResponse> {
    ...
    const promise = this.rpc.request("cosmos.gov.v1beta2.Msg", "ExecLegacyContent", data);
  ...
  VoteWeighted(request: MsgVoteWeighted): Promise<MsgVoteWeightedResponse> {
    ...
    const promise = this.rpc.request("cosmos.gov.v1beta2.Msg", "VoteWeighted", data);
