...
function createBaseBalancerPoolParams(): BalancerPoolParams {
...
export const BalancerPoolParams = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BalancerPoolParams {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBalancerPoolParams();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<BalancerPoolParams>, I>>(
    object: I
  ): BalancerPoolParams {
    const message = createBaseBalancerPoolParams();
...
function createBaseBalancerPool(): BalancerPool {
  return {
    address: "",
    id: Long.UZERO,
...
export const BalancerPool = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BalancerPool {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBalancerPool();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<BalancerPool>, I>>(
    object: I
  ): BalancerPool {
    const message = createBaseBalancerPool();
