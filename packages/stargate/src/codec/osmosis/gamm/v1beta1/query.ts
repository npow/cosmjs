...
function createBaseQueryPoolAssetsRequest(): QueryPoolAssetsRequest {
  return { poolId: Long.UZERO };
}
...
export const QueryPoolAssetsRequest = {
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryPoolAssetsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<QueryPoolAssetsRequest>, I>>(
    object: I
  ): QueryPoolAssetsRequest {
    const message = createBaseQueryPoolAssetsRequest();
    message.poolId =
...
function createBaseQueryPoolAssetsResponse(): QueryPoolAssetsResponse {
  return { poolAssets: [] };
}
...
export const QueryPoolAssetsResponse = {
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryPoolAssetsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial<I extends Exact<DeepPartial<QueryPoolAssetsResponse>, I>>(
    object: I
  ): QueryPoolAssetsResponse {
    const message = createBaseQueryPoolAssetsResponse();
    message.poolAssets =
  ...
  fromJSON(object: any): QuerySpotPriceRequest {
    return {
      ...
      tokenOutDenom: isSet(object.tokenOutDenom)
        ...
        : "",
      withSwapFee: isSet(object.withSwapFee)
        ? Boolean(object.withSwapFee)
        : false,
    };
  },
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.PoolAssets = this.PoolAssets.bind(this);
  ...
  PoolAssets(
  ...
  ): Promise<QueryPoolAssetsResponse> {
    ...
    return promise.then((data) =>
      QueryPoolAssetsResponse.decode(new _m0.Reader(data))
    );
  }
