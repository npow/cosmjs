  ...
  fromJSON(object: any): MsgCreateGauge {
    return {
      ...
      numEpochsPaidOver: isSet(object.numEpochsPaidOver)
        ? Long.fromString(object.numEpochsPaidOver)
        : Long.UZERO,
    };
  },
  ...
  toJSON(message: MsgCreateGauge): unknown {
    ...
    message.numEpochsPaidOver !== undefined &&
      (obj.numEpochsPaidOver = (
        message.numEpochsPaidOver || Long.UZERO
      ).toString());
    return obj;
  },
...
export const MsgAddToGauge = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddToGauge>, I>>(
    object: I
  ): MsgAddToGauge {
    const message = createBaseMsgAddToGauge();
    message.owner = object.owner ?? "";
...
export const MsgAddToGaugeResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddToGaugeResponse>, I>>(
    _: I
  ): MsgAddToGaugeResponse {
    const message = createBaseMsgAddToGaugeResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  AddToGauge(request: MsgAddToGauge): Promise<MsgAddToGaugeResponse> {
    ...
    return promise.then((data) =>
      MsgAddToGaugeResponse.decode(new _m0.Reader(data))
    );
  }
}
