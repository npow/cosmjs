...
export const PeriodLock = {
  ...
  fromPartial<I extends Exact<DeepPartial<PeriodLock>, I>>(
    object: I
  ): PeriodLock {
    const message = createBasePeriodLock();
    message.ID =
...
export const QueryCondition = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryCondition>, I>>(
    object: I
  ): QueryCondition {
    const message = createBaseQueryCondition();
...
function createBaseSyntheticLock(): SyntheticLock {
  return { underlyingLockId: Long.UZERO, suffix: "", endTime: undefined };
}
...
export const SyntheticLock = {
  ...
  toJSON(message: SyntheticLock): unknown {
    ...
    message.underlyingLockId !== undefined &&
      (obj.underlyingLockId = (
        message.underlyingLockId || Long.UZERO
      ).toString());
  ...
  fromPartial<I extends Exact<DeepPartial<SyntheticLock>, I>>(
    object: I
  ): SyntheticLock {
    const message = createBaseSyntheticLock();
