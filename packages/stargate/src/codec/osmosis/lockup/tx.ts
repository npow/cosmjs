...
export const MsgBeginUnlockingAll = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgBeginUnlockingAll>, I>>(
    object: I
  ): MsgBeginUnlockingAll {
    const message = createBaseMsgBeginUnlockingAll();
    message.owner = object.owner ?? "";
...
export const MsgBeginUnlocking = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgBeginUnlocking>, I>>(
    object: I
  ): MsgBeginUnlocking {
    const message = createBaseMsgBeginUnlocking();
    message.owner = object.owner ?? "";
...
export class MsgClientImpl implements Msg {
  ...
  BeginUnlockingAll(
    ...
    return promise.then((data) =>
      MsgBeginUnlockingAllResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  BeginUnlocking(
    ...
    return promise.then((data) =>
      MsgBeginUnlockingResponse.decode(new _m0.Reader(data))
    );
  }
}
