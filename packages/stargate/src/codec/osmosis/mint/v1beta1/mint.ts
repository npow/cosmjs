...
export const DistributionProportions = {
  ...
  fromPartial<I extends Exact<DeepPartial<DistributionProportions>, I>>(
    object: I
  ): DistributionProportions {
    const message = createBaseDistributionProportions();
  ...
  fromJSON(object: any): Params {
    return {
      ...
      reductionPeriodInEpochs: isSet(object.reductionPeriodInEpochs)
        ? Long.fromString(object.reductionPeriodInEpochs)
        : Long.ZERO,
      ...
      mintingRewardsDistributionStartEpoch: isSet(
        ...
        ? Long.fromString(object.mintingRewardsDistributionStartEpoch)
        : Long.ZERO,
    };
  },
