...
import {
  DistrInfo,
  Params,
} from "../../../osmosis/pool-incentives/v1beta1/incentives";
...
export const QueryGaugeIdsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGaugeIdsRequest>, I>>(
    object: I
  ): QueryGaugeIdsRequest {
    const message = createBaseQueryGaugeIdsRequest();
    message.poolId =
...
export const QueryGaugeIdsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGaugeIdsResponse>, I>>(
    object: I
  ): QueryGaugeIdsResponse {
    const message = createBaseQueryGaugeIdsResponse();
...
export const QueryGaugeIdsResponse_GaugeIdWithDuration = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryGaugeIdsResponse_GaugeIdWithDuration>, I>
  >(object: I): QueryGaugeIdsResponse_GaugeIdWithDuration {
    const message = createBaseQueryGaugeIdsResponse_GaugeIdWithDuration();
    message.gaugeId =
...
export const QueryDistrInfoRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryDistrInfoRequest>, I>>(
    _: I
  ): QueryDistrInfoRequest {
    const message = createBaseQueryDistrInfoRequest();
    return message;
...
export const QueryDistrInfoResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryDistrInfoResponse>, I>>(
    object: I
  ): QueryDistrInfoResponse {
    const message = createBaseQueryDistrInfoResponse();
    message.distrInfo =
...
export const IncentivizedPool = {
  ...
  fromPartial<I extends Exact<DeepPartial<IncentivizedPool>, I>>(
    object: I
  ): IncentivizedPool {
    const message = createBaseIncentivizedPool();
    message.poolId =
...
export const QueryExternalIncentiveGaugesRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryExternalIncentiveGaugesRequest>, I>
  >(_: I): QueryExternalIncentiveGaugesRequest {
    const message = createBaseQueryExternalIncentiveGaugesRequest();
    return message;
  },
};
...
export const QueryExternalIncentiveGaugesResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryExternalIncentiveGaugesResponse>, I>
  >(object: I): QueryExternalIncentiveGaugesResponse {
    const message = createBaseQueryExternalIncentiveGaugesResponse();
...
export class QueryClientImpl implements Query {
  ...
  GaugeIds(request: QueryGaugeIdsRequest): Promise<QueryGaugeIdsResponse> {
    ...
    return promise.then((data) =>
      QueryGaugeIdsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  DistrInfo(request: QueryDistrInfoRequest): Promise<QueryDistrInfoResponse> {
    ...
    return promise.then((data) =>
      QueryDistrInfoResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  IncentivizedPools(
    ...
    return promise.then((data) =>
      QueryIncentivizedPoolsResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ExternalIncentiveGauges(
    ...
    return promise.then((data) =>
      QueryExternalIncentiveGaugesResponse.decode(new _m0.Reader(data))
    );
  }
}
