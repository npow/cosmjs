...
const baseNodeInfo: object = { nodeId: "", listenAddr: "", network: "", version: "", moniker: "" };
...
export const NodeInfo = {
  ...
  toJSON(message: NodeInfo): unknown {
    ...
    message.other !== undefined &&
      (obj.other = message.other ? NodeInfoOther.toJSON(message.other) : undefined);
    return obj;
  },
...
export const PeerAddressInfo = {
  ...
  fromJSON(object: any): PeerAddressInfo {
    ...
    if (object.lastDialSuccess !== undefined && object.lastDialSuccess !== null) {
      message.lastDialSuccess = fromJsonTimestamp(object.lastDialSuccess);
    } else {
      message.lastDialSuccess = undefined;
    }
    if (object.lastDialFailure !== undefined && object.lastDialFailure !== null) {
  ...
  toJSON(message: PeerAddressInfo): unknown {
    ...
    message.dialFailures !== undefined && (obj.dialFailures = message.dialFailures);
    return obj;
  },
