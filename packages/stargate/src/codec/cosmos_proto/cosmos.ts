...
const baseScalarDescriptor: object = { name: "", description: "", fieldType: 0 };
...
export const ScalarDescriptor = {
  ...
  fromJSON(object: any): ScalarDescriptor {
    ...
    if (object.fieldType !== undefined && object.fieldType !== null) {
      for (const e of object.fieldType) {
        message.fieldType.push(scalarTypeFromJSON(e));
      }
    }
    return message;
  },
